...
#BRATS_TRAIN_FOLDERS="/home/lab/hualing/BraTs/MICCAI_BraTS2020_TrainingData"
BRATS_TRAIN_FOLDERS="/home/lab/hualing/BraTs/RSNA_ASNR_MICCAI_BraTS2021_TrainingData_16July2021"
#TEST_FOLDER = "test_data"
#TEST_FOLDER="/home/lab/hualing/BraTs/MICCAI_BraTS2020_ValidationData"
TEST_FOLDER="/home/lab/hualing/BraTs/RSNA_ASNR_MICCAI_BraTS2021_ValidationData"
...
class Brats(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #    #patient_label = np.stack([ed, et, nrc])


        #if _patient["seg"] is not None:

        #    et_present = 1 if np.any(patient_label==4) else 0
        ...
        if self.training:
            ...
            #patient_image= pad_or_crop_image(patient_image, target_size=(128, 128, 128))
            #patient_label = pad_or_crop_image_seg(patient_label, target_size=(128, 128, 128))
...
def get_test_datasets(seed, on="train", fold_number=0, normalisation="minmax"):
    ...
    bench_dataset = Brats(patients_dir, training=False,no_seg=True, benchmarking=True,
                          normalisation=normalisation)
